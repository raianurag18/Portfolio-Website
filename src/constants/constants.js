export const projects = [
  {
    ...
    description: "A full-stack web application designed to help students stay informed about campus placements. The platform offers real-time insights into company visits, job offer statistics, placement trends, and interview experiences submitted by peers. It features an admin dashboard for verifying user-submitted data and provides a smooth, intuitive interface for both admins and students.",
      image: '/images/1.png',
      tags: ['Mongodb', 'Express', 'React', 'Node'],
    source: 'https://github.com/raianurag18/placement-tracker',
    visit: 'https://github.com/raianurag18/placement-tracker',
    id: 0,
  },
  {
    title: 'Law Firm App',
